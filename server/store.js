  ...
  db.invoices = [
    {
      ...
      items: [
        { description: 'Edge Gateway Pro', qty: 8, unitPrice: 8900, amount: 71200 },
        { description: 'Committed remainder — site install', qty: 1, unitPrice: 27056, amount: 27056 },
      ],
      lines: [{ number: 'INV-2201', amount: 98256, status: 'unpaid', dueDate: '2026-09-20' }],
      approvedBy: [{ name: 'Jordan Chen', role: 'manager', roleLabel: 'Sales Manager' }],
    ...
    },
    {
      ...
      items: [
        { description: 'Industrial Sensor Array', qty: 3, unitPrice: 12500, amount: 37500 },
        { description: 'Commissioning visit', qty: 1, unitPrice: 6600, amount: 6600 },
      ],
      lines: [{ number: 'INV-2198', amount: 44100, status: 'paid', dueDate: '2026-08-30' }],
      approvedBy: [
        { name: 'Jordan Chen', role: 'manager', roleLabel: 'Sales Manager' },
        { name: 'Sam Patel', role: 'finance', roleLabel: 'Finance' },
      ],
      paymentRecordedBy: { name: 'Alex Rivera', role: 'rep', roleLabel: 'Sales Rep' },
    },
    {
      id: 'inv-2194',
      number: 'INV-2194',
      ...
      items: [{ description: 'Spare Parts Kit', qty: 10, unitPrice: 2016, amount: 20160 }],
      lines: [{ number: 'INV-2194', amount: 20160, status: 'unpaid', dueDate: '2026-09-02' }],
      approvedBy: [{ name: 'Policy engine', role: 'system', roleLabel: 'Within-limit auto-approval' }],
      paymentRecordedBy: null,
    },
    {
      id: 'inv-2188',
      ...
      items: [
        { description: 'Predictive Maintenance Suite — annual', qty: 1, unitPrice: 19200, amount: 19200 },
      ],
